...
```javascript
iterCosineWave = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-cosine-wave@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-cosine-wave@umd/bundle.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/simulate-iter-cosine-wave/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/simulate-iter-cosine-wave/actions/workflows/test.yml?query=branch:main
