...
```javascript
import iterCosineWave from 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-cosine-wave@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/simulate-iter-cosine-wave/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/simulate-iter-cosine-wave/actions/workflows/test.yml?query=branch:v0.2.3
